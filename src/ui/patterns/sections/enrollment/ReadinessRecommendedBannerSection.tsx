    ...
    <div className="rounded-2xl border-2 border-primary/30 bg-gradient-to-br from-primary/5 via-primary/5 to-muted px-5 py-4">
      <div className="mb-3 flex items-start justify-between">
        <div className="flex items-center gap-2">
          ...
          <p className="text-[0.9rem] font-bold text-primary">Recommended for You</p>
        </div>
      ...
      <p className="text-[0.8rem] leading-relaxed text-secondary">
        You can reach a score of <span className="font-semibold text-brand">{potentialScore}</span> — apply the
