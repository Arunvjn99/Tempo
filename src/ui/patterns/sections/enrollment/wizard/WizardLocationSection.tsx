...
export function WizardLocationSection({
  ...
  return (
    <div className="mt-6 space-y-5">
      <div>
        <h2 className="text-lg font-semibold text-primary sm:text-xl">Where do you imagine retiring?</h2>
        <p className="mt-1 text-[0.875rem] text-secondary">Location helps estimate cost of living.</p>
      </div>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-xl border border-default bg-background py-3 pl-10 pr-4 text-[0.9rem] text-primary transition-all focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
        />
      </div>

      <p className="text-[0.8rem] font-medium text-secondary">Popular retirement destinations</p>
          ...
          <Button
            ...
            className={cn(
              ...
              personalization.retirementLocation === loc.name
                ...
                : "border-default bg-surface-card hover:border-primary/40",
            )}
          >
            ...
            <span
              className={cn(
                ...
                personalization.retirementLocation === loc.name ? "text-brand" : "text-primary",
              )}
            >
              {loc.name}
            </span>
      ...
      <Button
        ...
        className={cn(
          ...
          personalization.retirementLocation === "Not sure yet"
            ...
            : "border-default bg-surface-card text-primary hover:border-primary/30",
        )}
      >
        Not sure yet
      </Button>
