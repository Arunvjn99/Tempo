    ...
    >
      {!hideBack && (
        <motion.button
          ...
          className={cn(
            "inline-flex items-center gap-sm rounded-button border border-default bg-surface px-md py-sm text-sm font-medium text-primary transition-colors hover:bg-primary/5",
