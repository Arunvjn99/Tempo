export function loadUXsniff(): void {
  ...
  if ((window as unknown as Record<string, unknown>).__uxsniff_loaded) return;
  (window as unknown as Record<string, unknown>).__uxsniff_loaded = true;
  ...
  ux.q = [];
  (window as unknown as Record<string, unknown>).ux = ux;
