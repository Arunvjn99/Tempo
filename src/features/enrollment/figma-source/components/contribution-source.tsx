    ...
    <div className="space-y-5 max-w-7xl mx-auto">
      ...
      <div>
        ...
        <div className="flex items-start justify-between gap-6">
          <div>
            <h1 className="text-3xl font-semibold text-[var(--text-primary)]">How do you want to pay taxes?</h1>
            <p className="text-[var(--text-secondary)] mt-2 text-base leading-relaxed">Choose when you want to pay taxes on your savings.</p>
          </div>
          {/* Simplified Banner */}
          <div className="inline-flex shrink-0 items-center gap-3 rounded-xl border border-[color-mix(in_srgb,var(--color-primary)_20%,var(--border-default))] bg-[color-mix(in_srgb,var(--color-primary)_10%,var(--surface-card))] px-5 py-3">
        ...
        <div className="card-standard border-2 border-[color-mix(in_srgb,var(--color-primary)_15%,var(--border-default))] p-6 flex gap-6">
          ...
          <div className="flex-1 space-y-4 flex flex-col" style={{ width: "70%" }}>
            ...
            <div className="space-y-2">
              <div className="h-4 rounded-full overflow-hidden flex  border border-[var(--border-default)]">
                ...
                {sources.roth > 0 && (
                  <div 
                    className="bg-[color:var(--color-primary)] transition-all duration-300"
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <p className="text-[color:var(--color-primary)] text-xl font-extrabold leading-none">
                    {sources.roth}%
                  </p>
                </div>
                <input
                  ...
                  className="h-2 w-full cursor-pointer appearance-none rounded-full bg-[var(--surface-section)] accent-[var(--color-primary)]"
                  style={{
                    background: `linear-gradient(to right, var(--color-primary) 0%, var(--color-primary) ${sources.roth}%, var(--surface-section) ${sources.roth}%, var(--surface-section) 100%)`,
                  }}
                />
                <div className="flex items-center justify-between text-[var(--text-secondary)] text-xs">
                  <span>0%</span>
                ...
                <div className="space-y-2 border-t border-[var(--border-default)] pt-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="h-2 w-full cursor-pointer appearance-none rounded-full bg-[var(--surface-section)] accent-[var(--color-primary)]"
                      style={{
                        background: `linear-gradient(to right, var(--color-primary) 0%, var(--color-primary) ${sources.afterTax}%, var(--surface-section) ${sources.afterTax}%, var(--surface-section) 100%)`,
                      }}
                    />
                    <div className="flex items-center justify-between text-[var(--text-secondary)] text-xs">
                      <span>0%</span>
            ...
            <div className="bg-[color-mix(in_srgb,var(--color-primary)_10%,var(--surface-card))] border border-[color-mix(in_srgb,var(--color-primary)_20%,var(--border-default))] rounded-xl p-3">
              ...
              <button
                onClick={handleNext}
                disabled={total !== 100}
                className="w-full mt-3 bg-[var(--surface-card)] text-[var(--text-primary)] py-2 px-4 rounded-lg hover:bg-[var(--surface-card)] border border-[var(--border-default)] transition-all border border-[var(--border-default)] disabled:opacity-50 disabled:cursor-not-allowed text-xs font-semibold"
              >
          ...
          <div className="border-l border-[var(--border-default)] pl-5 flex flex-col justify-between" style={{ width: "30%" }}>
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="space-y-1.5 pl-3 border-l-2 border-[var(--border-default)]">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1.5">
                      <div className="w-1.5 h-1.5 rounded-full bg-[color:var(--color-primary)]" />
                      <p className="text-[var(--text-secondary)] text-xs">
                        Roth
                      </p>
                    </div>
            ...
            <button
              onClick={handleNext}
              disabled={total !== 100}
              className="bg-[var(--surface-card)] text-[var(--text-primary)] py-2 px-4 rounded-lg hover:bg-[var(--surface-card)] border border-[var(--border-default)] transition-all border border-[var(--border-default)] disabled:opacity-50 disabled:cursor-not-allowed text-xs font-semibold"
            >
              Continue with Custom Allocation
            </button>
          </div>
      ...
      <div className="space-y-3 opacity-90">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
          ...
          {/* Roth Card */}
          <div className="rounded-xl border border-[var(--border-default)] bg-[color-mix(in_srgb,var(--color-primary)_8%,var(--surface-card))] p-4">
            <div className="mb-3 flex items-center gap-2.5">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[color:var(--color-primary)]">
            ...
            <div className="space-y-1.5">
              <div className="flex items-start gap-2">
                <Check className="w-3.5 h-3.5 text-[color:var(--color-primary)] mt-0.5 shrink-0" />
                <p className="text-[var(--text-primary)] text-xs">
                  Tax-free withdrawals later
                </p>
              </div>
          ...
          {/* After-Tax Card */}
          <div className="rounded-xl border border-warning/25 bg-gradient-to-br from-warning/10 to-warning/[0.04] p-4 md:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2.5 mb-3">
              <div className="w-8 h-8 rounded-lg bg-[color:var(--color-primary)] flex items-center justify-center">
                <DollarSign className="w-4 h-4 text-[var(--primary-foreground)]" />
              </div>
              <h3 className="text-[var(--text-primary)] text-base font-bold">
                After-Tax
              </h3>
