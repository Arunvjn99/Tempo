        ...
        <div className="px-6 py-5 space-y-5">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 rounded-xl border border-[color-mix(in_srgb,var(--color-primary)_20%,var(--border-default))] bg-[color-mix(in_srgb,var(--color-primary)_10%,var(--surface-card))] p-3 text-center">
          ...
          <div>
            ...
            <div className="space-y-3">
              {/* Readiness score */}
              <div className="flex items-center justify-between bg-[var(--surface-card)] border border-[var(--border-default)]  rounded-xl px-4 py-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className="text-[var(--color-primary)] flex items-center gap-0.5 bg-[color-mix(in_srgb,var(--color-primary)_10%,var(--surface-card))] px-1.5 py-0.5 rounded text-xs font-semibold"
                  >
              ...
              {balanceDiff > 0 && (
                <div className="bg-[color-mix(in_srgb,var(--color-primary)_10%,var(--surface-card))] border border-[color-mix(in_srgb,var(--color-primary)_30%,var(--border-default))] rounded-xl px-4 py-2.5 text-center">
      ...
      <div className="grid md:grid-cols-[1fr_340px] lg:grid-cols-[1fr_380px] gap-6 items-start">
        ...
        <div className="space-y-5 min-w-0">
          ...
          <div className="card-standard p-6">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-[var(--text-secondary)] mt-1 text-center text-xs">
                Most participants your age aim for a readiness score of 65 or higher.
              </p>
              
              {/* Target benchmark indicator */}
              <div className="mt-4 flex items-center justify-center gap-2">
                <div className="h-1.5 w-24 bg-surface-tertiary border border-[var(--border-default)] rounded-full overflow-hidden">
                  <div 
                    className="h-full rounded-full bg-[var(--surface-section)]" 
                    style={{ width: "65%" }}
                  />
                </div>
          ...
          {successMessage && (
            <div
              className="bg-[color-mix(in_srgb,var(--color-primary)_10%,var(--surface-card))] border border-[color-mix(in_srgb,var(--color-primary)_30%,var(--border-default))] rounded-2xl px-5 py-3.5 flex items-center gap-3"
        ...
        <div className="space-y-4 min-w-0">
          ...
          {suggestions.length > 0 && totalPotentialIncrease > 0 && (
            <div className="rounded-2xl border-2 border-[color-mix(in_srgb,var(--color-primary)_20%,var(--border-default))] bg-gradient-to-br from-[color-mix(in_srgb,var(--color-primary)_10%,var(--surface-card))] via-[color-mix(in_srgb,var(--color-primary)_8%,var(--surface-section))] to-[color-mix(in_srgb,var(--color-primary)_6%,var(--surface-card))] px-5 py-4">
              <div className="mb-3 flex items-start justify-between">
                ...
                <div className="px-2 py-1 bg-[color-mix(in_srgb,var(--color-primary)_14%,var(--surface-card))] rounded-lg">
                  ...
                  return (
                    <div
                      ...
                      className={`rounded-xl border transition-all ${
                        isRecommended
                          ? "border-[color-mix(in_srgb,var(--color-primary)_20%,var(--border-default))] bg-[var(--surface-card)]"
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex items-start gap-3">
                          <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 mt-0.5 transition-colors ${
                            isRecommended ? "bg-[color-mix(in_srgb,var(--color-primary)_10%,var(--surface-card))]" : "bg-[var(--surface-card)] border border-[var(--border-default)]"
                          }`}>
                            {suggestion.icon}
                          </div>
                        ...
                        <button
                          ...
                          className="mt-3 w-full rounded-lg border border-[color-mix(in_srgb,var(--color-primary)_20%,var(--border-default))] bg-[var(--surface-card)] px-4 py-2 text-xs font-semibold text-[var(--text-primary)] transition-all hover:bg-[color-mix(in_srgb,var(--color-primary)_10%,transparent)]"
                        >
          ...
          {suggestions.length === 0 && appliedChanges.length > 0 && (
            <div className="bg-[color-mix(in_srgb,var(--color-primary)_10%,var(--surface-card))] border border-[color-mix(in_srgb,var(--color-primary)_30%,var(--border-default))] rounded-2xl px-5 py-4 text-center">
          ...
          <div className="space-y-2.5 pt-4 border-t border-[var(--border-default)] mt-4">
            ...
            <button
              onClick={handleNext}
              className="w-full bg-[var(--surface-card)] text-[var(--text-primary)] py-3 px-4 rounded-xl flex items-center justify-center gap-2 hover:bg-[var(--surface-card)] border border-[var(--border-default)] transition-all border border-[var(--border-default)] text-sm font-semibold"
            >
