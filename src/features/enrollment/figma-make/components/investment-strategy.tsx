...
import { InvestmentHeader } from "./investment/InvestmentHeader";
...
/** Distinct tax-source hues (matches contribution-source: primary / purple / warning). */
const sourceColors: Record<SourceKey, string> = {
  preTax: "var(--color-primary)",
  roth: "var(--color-purple)",
  afterTax: "var(--color-warning)",
};

const sourceBorderColors: Record<SourceKey, string> = {
  preTax: "border-[color-mix(in_srgb,var(--color-primary)_22%,var(--border-default))]",
  roth: "border-[color-mix(in_srgb,var(--color-purple)_26%,var(--border-default))]",
  afterTax: "border-[color-mix(in_srgb,var(--color-warning)_28%,var(--border-default))]",
};

const sourceBgColors: Record<SourceKey, string> = {
  preTax: "bg-[color-mix(in_srgb,var(--color-primary)_10%,var(--surface-card))]",
  roth: "bg-[color-mix(in_srgb,var(--color-purple)_12%,var(--surface-card))]",
  afterTax: "bg-[color-mix(in_srgb,var(--color-warning)_10%,var(--surface-card))]",
};
                ...
                <div className="flex items-start justify-between mb-2">
                  ...
                  <div className="flex items-center gap-1.5 shrink-0 ml-2">
                    <button
                      ...
                      className="w-6 h-6 rounded-md flex items-center justify-center text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-card)] border border-[var(--border-default)] transition-colors"
                    >
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="space-y-5">
        ...
        <div className="rounded-2xl border border-[var(--border-default)] bg-[var(--surface-card)] px-5 py-4 shadow-[var(--shadow-lg)]">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[var(--surface-section)]">
                  ...
                  <button
                    ...
                    className={`rounded-xl border-2 p-3 text-center transition-all ${
                      data.riskLevel === level.key
                        ? "border-[var(--color-primary)] bg-[var(--surface-card)]"
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-[minmax(0,3fr)_minmax(0,2fr)]">
          ...
          <div className="rounded-2xl border border-[var(--border-default)] bg-[var(--surface-card)] p-7 shadow-[var(--shadow-lg)]">
              ...
              {/* Why this works */}
              <div className="mb-4 rounded-xl border border-[var(--border-insight)] bg-[var(--surface-insight-well)] p-3">
          ...
          <div className="relative flex flex-col overflow-hidden rounded-2xl border border-[var(--border-default)] p-8 shadow-[var(--shadow-lg)] [background:var(--gradient-investment-customize)]">
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-xl border border-[var(--border-default)] bg-[var(--surface-card)] py-2.5 px-6 text-sm font-semibold text-[var(--text-primary)] transition-all hover:bg-[var(--surface-section)] active:scale-[0.98]"
            >
        ...
        <div className="rounded-2xl border border-[var(--border-default)] p-7 shadow-[var(--shadow-lg)] [background:var(--gradient-investment-advisor)]">
                ...
                <div className="flex-1 flex flex-col md:w-3/5 bg-[var(--surface-card)] border border-[var(--border-default)] ">
                  ...
                  <div className="px-6 py-4 border-t border-[var(--border-default)] bg-[var(--surface-card)]">
                    <div className="flex items-center gap-3">
                      <button
                        onClick={handleCloseInline}
                        className="flex-1 px-5 py-2.5 rounded-xl border border-[var(--border-default)] text-[var(--text-secondary)] hover:bg-[var(--surface-card)] transition-colors text-sm font-medium"
                      >
                        Cancel
                      </button>
                      <button
