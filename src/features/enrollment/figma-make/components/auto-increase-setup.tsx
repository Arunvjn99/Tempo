    ...
    <div className="space-y-5">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            <div className="mb-1 flex items-center gap-2.5">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[color-mix(in_srgb,var(--color-success)_18%,var(--surface-card))]">
                <TrendingUp className="h-[18px] w-[18px] text-[var(--color-success)]" />
              </div>
              <h1 className="text-[var(--text-primary)]">Configure your automatic increases</h1>
            </div>
      ...
      <div className="grid lg:grid-cols-5 gap-5 items-start">
        ...
        <div className="lg:col-span-3 space-y-4 order-1">
          ...
          {/* Maximum Contribution Slider — purple (Figma Roth / cap lane) */}
          <div className="rounded-xl border border-[color-mix(in_srgb,var(--color-purple)_28%,var(--border-default))] bg-[var(--color-purple-soft)] px-5 py-4">
            <div className="flex items-start gap-3">
              <div className="w-9 h-9 rounded-lg bg-[var(--color-purple-muted)] flex items-center justify-center shrink-0 mt-0.5">
              ...
              <div className="flex-1">
                ...
                <div className="mt-4">
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <span className="text-[var(--color-purple)] tabular-nums text-base font-bold">
                      {maxContribution}%
                    </span>
                  ...
                  <input
                    ...
                    className="h-2 w-full cursor-pointer appearance-none rounded-full bg-[var(--surface-section)] accent-[var(--color-purple)]"
                      style={{
                      background: `linear-gradient(to right, var(--color-purple) 0%, var(--color-purple) ${((maxContribution - 10) / 5) * 100}%, var(--surface-section) ${((maxContribution - 10) / 5) * 100}%, var(--surface-section) 100%)`,
                    }}
                  />
                </div>
              </div>
                ...
                <div className="px-5 py-4 space-y-3">
                  ...
                  <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-2">
                    ...
                    <div className="bg-[color-mix(in_srgb,var(--color-primary)_10%,var(--surface-card))] border border-[color-mix(in_srgb,var(--color-primary)_30%,var(--border-default))] rounded-xl px-3 py-3 text-center">
                      <p
                        className="text-[color-mix(in_srgb,var(--color-primary)_80%,var(--text-primary))] mb-0.5 text-xs font-semibold uppercase tracking-wide"
                      >
                        With increases
                      </p>
                      <p className="text-[color-mix(in_srgb,var(--color-primary)_80%,var(--text-primary))] tabular-nums text-lg font-bold">
                            ...
                            <td className="px-3 py-1.5">
                              <div className="flex items-center gap-1">
                                ...
                                {row.percent === maxContribution && (
                                  <span className="px-1 py-0.5 bg-[color-mix(in_srgb,var(--color-primary)_16%,var(--surface-card))] text-[color-mix(in_srgb,var(--color-primary)_72%,var(--text-primary))] rounded text-xs font-semibold">
                                    MAX
                                  </span>
                                )}
                              </div>
