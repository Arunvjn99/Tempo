...
export function WithdrawalPayment() {
  ...
  const handleContinue = () => {
    ...
    navigate("/transactions/withdrawal/review");
  };
  ...
  return (
    <div className="space-y-6">
        ...
        <Card className="p-6">
          ...
          >
            <div className="space-y-3">
              <div className="flex items-start space-x-3 p-4 border border-default rounded-lg hover:border-primary/40 transition-colors">
      ...
      {paymentMethod === "eft" && (
        ...
        >
          <Card className="p-6">
            <h3 className="font-semibold text-primary mb-4">Bank Account</h3>
        ...
        >
          ...
          >
            <Card className="rounded-2xl border-default/80 overflow-hidden">
              <CollapsibleTrigger asChild>
                <button className="w-full flex items-center justify-between p-5 text-left hover:bg-primary/5 transition-colors cursor-pointer">
                  <div className="flex items-center gap-3">
                    <div className="p-2 rounded-lg bg-[color-mix(in_srgb,var(--color-success)_10%,var(--surface-card))] text-[var(--color-success)]">
              ...
              <CollapsibleContent>
                <div className="px-5 pb-5 border-t border-default space-y-4">
                  <div className="pt-4">
                  ...
                  <div className="p-3 bg-[color-mix(in_srgb,var(--color-primary)_10%,var(--surface-card))]/60 rounded-xl border border-[color-mix(in_srgb,var(--color-primary)_22%,var(--border-default))]/60">
      ...
      <div className="flex justify-between items-center" style={{ paddingTop: 16 }}>
        <button
          onClick={() => navigate("/transactions/withdrawal/fees")}
