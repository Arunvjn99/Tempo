...
const loanTypes = [
  ...
  },
  {
    ...
    icon: Building2,
    iconBg: "color-mix(in srgb, var(--color-success) 8%, var(--surface-card))",
  ...
  },
  {
    ...
    icon: RefreshCw,
    iconBg: "color-mix(in srgb, var(--color-accent) 10%, var(--surface-card))",
  ...
  return (
    <div className="space-y-4">
            ...
            {loanTypes.map((type) => {
              ...
              return (
                <button
                  ...
                  style={{
                    position: "relative",
                    background: isSelected ? "color-mix(in srgb, var(--color-primary) 6%, var(--surface-card))" : "var(--color-card)",
                    border: isSelected
      ...
      >
        <div
          style={{
            background: "linear-gradient(135deg, var(--surface-soft) 0%, color-mix(in srgb, var(--color-primary) 14%, var(--surface-card)) 100%)",
            borderRadius: 14,
            border: "1px solid color-mix(in srgb, var(--color-primary) 22%, var(--surface-card))",
            padding: "18px 22px",
            display: "flex",
            alignItems: "center",
            gap: 16,
        ...
        >
                ...
                style={{
                  ...
                  border:
                    disbursementMethod === "eft"
                      ...
                      : "1.5px solid var(--border-default)",
                  background:
                    disbursementMethod === "eft" ? "color-mix(in srgb, var(--color-primary) 6%, var(--surface-card))" : "var(--color-card)",
                }}
              >
                ...
                style={{
                  ...
                  border:
                    disbursementMethod === "check"
                      ...
                      : "1.5px solid var(--border-default)",
                  background:
                    disbursementMethod === "check" ? "color-mix(in srgb, var(--color-primary) 6%, var(--surface-card))" : "var(--color-card)",
                }}
              >
          ...
          {disbursementMethod === "eft" && showEftTip && (
            <div
              style={{
                marginTop: 16,
                background: "linear-gradient(135deg, color-mix(in srgb, var(--color-accent) 10%, var(--surface-card)) 0%, color-mix(in srgb, var(--color-accent) 14%, var(--surface-card)) 100%)",
                borderRadius: 12,
                border: "1px solid color-mix(in srgb, var(--color-accent) 28%, var(--border-default))",
                padding: "14px 18px",
                position: "relative",
              }}
            >
              <button
                ...
                style={{
                  ...
                  border: "none",
                  color: "color-mix(in srgb, var(--color-accent) 55%, var(--text-primary))",
                  padding: 2,
                }}
              >
              ...
              <div className="flex items-center gap-2" style={{ marginBottom: 8 }}>
                ...
                >
                  <Sparkles className="text-primary-foreground" style={{ width: 14, height: 14 }} />
                </div>
                <span style={{ fontSize: 13, fontWeight: 700, color: "var(--color-accent)", letterSpacing: "0.3px" }}>
              ...
              >
                EFT is the <strong style={{ color: "var(--color-accent)" }}>fastest disbursement method</strong> — funds typically arrive in 2-3 business days. It also reduces the risk of lost or delayed checks and has a lower processing fee.
              </p>
            </div>
          )}
          ...
          {showAmortization && (
            ...
            >
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
                <div style={{ background: "var(--color-card)", borderRadius: 8, padding: "8px 10px", border: "1px solid var(--border-default)" }}>
                  <p style={{ fontSize: 10, fontWeight: 500, color: "var(--text-secondary)", marginBottom: 2 }}>Total Repayment</p>
                  <p style={{ fontSize: 14, fontWeight: 700, color: "var(--text-primary)" }}>$5,200.00</p>
                </div>
                <div style={{ background: "var(--color-card)", borderRadius: 8, padding: "8px 10px", border: "1px solid var(--border-default)" }}>
                  <p style={{ fontSize: 10, fontWeight: 500, color: "var(--text-secondary)", marginBottom: 2 }}>Total Interest</p>
                  <p style={{ fontSize: 14, fontWeight: 700, color: "var(--color-primary)" }}>$200.00</p>
                </div>
                <div style={{ background: "var(--color-card)", borderRadius: 8, padding: "8px 10px", border: "1px solid var(--border-default)" }}>
                  <p style={{ fontSize: 10, fontWeight: 500, color: "var(--text-secondary)", marginBottom: 2 }}>Number of Payments</p>
                  <p style={{ fontSize: 14, fontWeight: 700, color: "var(--text-primary)" }}>52</p>
                </div>
              </div>
            </div>
          )}
          ...
          <div style={{ marginBottom: 18 }}>
            ...
            <label
              ...
              style={{
                ...
                background:
                  repaymentMethod === "payroll"
                    ? "color-mix(in srgb, var(--color-primary) 8%, var(--surface-card))"
                    : "var(--color-card)",
                textAlign: "center",
                position: "relative",
              }}
            >
              {repaymentMethod === "payroll" && (
                <div style={{ position: "absolute", top: -6, right: -6, width: 20, height: 20, borderRadius: "50%", background: "var(--color-primary)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <Check className="text-primary-foreground" style={{ width: 12, height: 12 }} strokeWidth={3} />
                </div>
              )}
              <div
                style={{
                  ...
                  height: 36,
                  borderRadius: 8,
                  background: repaymentMethod === "payroll" ? "color-mix(in srgb, var(--color-primary) 22%, var(--surface-card))" : "var(--surface-muted)",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                }}
              >
                <CreditCard
                  style={{
                    width: 18,
                    height: 18,
                    color: repaymentMethod === "payroll" ? "var(--color-primary)" : "var(--text-secondary)",
                  }}
                />
              </div>
              ...
              <span style={{ fontSize: 11, fontWeight: 500, color: "var(--text-secondary)", lineHeight: "15px" }}>
            ...
            >
              ...
              <div
                style={{
                  ...
                  height: 36,
                  borderRadius: 8,
                  background: repaymentMethod === "ach" ? "color-mix(in srgb, var(--color-primary) 22%, var(--surface-card))" : "var(--surface-muted)",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                }}
              >
                <Building
                  style={{
                    width: 18,
                    height: 18,
                    color: repaymentMethod === "ach" ? "var(--color-primary)" : "var(--text-secondary)",
                  }}
                />
              </div>
              <span style={{ fontSize: 13, fontWeight: 700, color: "var(--text-primary)" }}>
            ...
            >
              ...
              <div
                style={{
                  ...
                  height: 36,
                  borderRadius: 8,
                  background: repaymentMethod === "manual" ? "color-mix(in srgb, var(--color-primary) 22%, var(--surface-card))" : "var(--surface-muted)",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                }}
              >
                <ArrowLeftRight
                  style={{
                    width: 18,
                    height: 18,
                    color: repaymentMethod === "manual" ? "var(--color-primary)" : "var(--text-secondary)",
                  }}
                />
              </div>
              <span style={{ fontSize: 13, fontWeight: 700, color: "var(--text-primary)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            <div>
              ...
              <div className="flex items-center gap-1">
                <Info style={{ width: 12, height: 12, color: "var(--text-secondary)" }} />
                  ...
                  <div className="flex items-center gap-3.5">
                    <div
                      ...
                      style={{
                        ...
                        borderRadius: 10,
                        background:
                          "linear-gradient(135deg, color-mix(in srgb, var(--color-success) 8%, var(--surface-card)) 0%, color-mix(in srgb, var(--color-success) 14%, var(--surface-card)) 100%)",
