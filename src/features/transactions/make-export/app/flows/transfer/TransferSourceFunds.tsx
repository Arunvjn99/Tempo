...
export function TransferSourceFunds() {
  ...
  const handleContinue = () => {
    ...
    navigate("/transactions/transfer/destination");
  };
      ...
      >
        <div className="card-standard" style={{ padding: "20px 24px" }}>
          <div className="flex items-center justify-between">
            <div>
              <p style={{ fontSize: 11, fontWeight: 600, color: "var(--text-secondary)", textTransform: "uppercase", letterSpacing: "0.5px", marginBottom: 2 }}>Selected for Transfer</p>
            ...
            <div className="text-right">
              <p style={{ fontSize: 11, fontWeight: 600, color: "var(--text-secondary)", textTransform: "uppercase", letterSpacing: "0.5px", marginBottom: 2 }}>Available Balance</p>
              <p style={{ fontSize: 20, fontWeight: 800, color: "var(--text-primary)", letterSpacing: "-0.3px" }}>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono" style={{ fontSize: 10, color: "var(--text-secondary)", fontWeight: 500 }}>
                      {fund.ticker}
                    </span>
                  </div>
                  <div className="flex items-center gap-3 mt-1">
                    ...
                    <span className="flex items-center gap-0.5" style={{ fontSize: 11, fontWeight: 700, color: "var(--color-success)" }}>
                      {fund.ytdReturn > 0 ? (
