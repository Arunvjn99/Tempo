  ...
  return (
    <div className="space-y-6">
              ...
              <div key={index}>
                ...
                <div className="flex items-center gap-4 mb-2">
                  <div className="flex-1 flex items-center gap-2">
                    <span style={{ fontSize: 12, fontWeight: 500, color: "var(--text-secondary)" }}>Current</span>
                    ...
                    <span style={{ fontSize: 13, fontWeight: 600, color: "var(--text-primary)", minWidth: 40 }}>{fund.currentAllocation}%</span>
                  </div>
                  <ArrowRight style={{ width: 16, height: 16, color: "var(--text-secondary)" }} />
                  <div className="flex-1 flex items-center gap-2">
                    <span style={{ fontSize: 12, fontWeight: 500, color: "var(--text-secondary)" }}>New</span>
                    <div className="flex-1 overflow-hidden bg-border" style={{ height: 6, borderRadius: 3 }}>
                ...
                {hasChanged && (
                  <p style={{ fontSize: 12, fontWeight: 700, color: change > 0 ? "var(--color-success)" : "var(--color-danger)" }}>
      ...
      <FlowInfoBanner variant="info">
        <h4 style={{ fontSize: 14, fontWeight: 700, color: "var(--text-primary)", letterSpacing: "-0.3px", marginBottom: 8 }}>Processing Details</h4>
        <ul className="space-y-2">
          {[
            ...
            <li key={i} className="flex items-start gap-2.5">
              ...
              <span style={{ fontSize: 13, fontWeight: 500, color: "var(--color-primary-active)" }}>{text}</span>
            </li>
          ))}
        </ul>
      </FlowInfoBanner>
      ...
      <FlowCard delay={0.15}>
        <div className="flex items-start gap-3">
          ...
          <label htmlFor="terms" className="cursor-pointer leading-relaxed" style={{ fontSize: 13, fontWeight: 500, color: "var(--text-primary)" }}>
      ...
      <FlowNavButtons
        onBack={() => navigate("/transactions/transfer/impact")}
        onNext={handleSubmit}
