      ...
      <div className="flex flex-col items-center gap-6 py-4">
        ...
        <div className="w-full px-4">
          <input
            ...
            className="h-1.5 w-full cursor-pointer appearance-none accent-[var(--color-primary)]"
          />
      ...
      <div className="flex flex-col items-center gap-4 pt-2">
        ...
        <div className="mt-2 w-full space-y-2">
          <div className="relative h-4 w-full shrink-0">
            <div className="absolute left-0 right-0 top-1/2 h-0.5 -translate-y-1/2 bg-[var(--border-default)]" />
            <div
            ...
            <div className="absolute right-0 top-1/2 h-2 w-2 -translate-y-1/2 rounded-full bg-[var(--border-default)]" />
            <div
    ...
    >
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-xl border border-[var(--border-default)] bg-[var(--surface-card)] py-3 pl-11 pr-4 text-sm font-medium text-[var(--text-primary)] transition-all focus:border-[var(--color-primary)] focus:outline-none focus:ring-2 focus:ring-[color-mix(in_srgb,var(--color-primary)_20%,transparent)]"
        />
      </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={cn(
                        ...
                        dest.cost === "Low Cost"
                          ? "bg-[color-mix(in_srgb,var(--color-success)_22%,var(--surface-card))] text-[var(--color-success)]"
                          : "bg-[color-mix(in_srgb,var(--color-warning)_24%,var(--surface-card))] text-[var(--color-warning)]",
                      )}
                    >
                      {dest.cost}
                    </span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {comfortLevels.map((level) => {
          ...
          return (
            ...
            >
              {level.popular && (
                <span className="absolute -top-2.5 right-3 rounded-full bg-[var(--color-warning)] px-2 py-0.5 text-xs font-semibold text-[var(--primary-foreground)]">
                  Most common
                </span>
              )}
                ...
                <div
                  className={cn(
                    ...
                    isActive
                      ...
                      : isCompleted
                        ? "bg-[var(--color-success)] text-[var(--primary-foreground)]"
                ...
                {s.id < wizardSteps.length && (
                  <div
                    className={cn(
                      ...
                      isCompleted ? "bg-[var(--color-success)]" : "border border-[var(--border-default)] bg-[var(--surface-card)]",
                    )}
                  />
                )}
              </div>
